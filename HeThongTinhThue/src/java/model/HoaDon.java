...
public class HoaDon {
    ...
    private ArrayList <ToKhaiThue> dsToKhaiThue;
    private NganHang nganHang;

    public HoaDon(int id, String soThe, String tenChuThe, String CVC, Date thangNamHetHan, int tienPhaiDong, Boolean trangThai, Date ngayYeuCau, Date ngayThanhToan, NguoiDung nguoiDung, ArrayList<ToKhaiThue> dsToKhaiThue, NganHang nganHang) {
        this.id = id;
        this.soThe = soThe;
        ...
        this.dsToKhaiThue = dsToKhaiThue;
    ...
    public ArrayList<ToKhaiThue> getDsToKhaiThue() {
        return dsToKhaiThue;
    }

    public void setDsToKhaiThue(ArrayList<ToKhaiThue> dsToKhaiThue) {
        this.dsToKhaiThue = dsToKhaiThue;
    }
