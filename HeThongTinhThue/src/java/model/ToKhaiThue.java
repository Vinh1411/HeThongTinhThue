...
public class ToKhaiThue {
    ...
    public ToKhaiThue(int id, String kyTinhThue, Date thoiGianBatDau, String loaiToKhai, int tienLuong, int tienDauTu, int tienKinhDoanh, int tienBatDongSan, int tienTrungThuong, int soNguoiPhuThuoc, int tienTuThien, int tienDongBaoHiem, int tienHuuTri, Date ngayNop, Boolean trangThai, NguoiDung nguoiDung) {
        this.id = id;
